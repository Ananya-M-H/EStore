            ...
            const loadingPayPalScript = async () =>{
                paypalDispatch({
                    ...
                    value : {
                        ...
                        currency : "USD" ,
                         components: "buttons", // make sure buttons are loaded
...
<Message variant= "danger">{error.data.message}</Message>
     ...
     <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row ">
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="mt-5 border-gray-300 pb-4 mb-4">
                ...
                <p className="mb-4">
                 ...
                 <p className="mb-4">
                  <strong className="text-pink-500">Method: 
                    </strong>{order.paymentMethod}
                </p>
                    {order.isPaid ? (
                 <Message variant="success" className="bg-[#202123] text-white mr-40">
             ...
             <h2 className="text-xl font-bold mb-12  mt-[3rem] ">Order Summary</h2>
