...
import {FaBox ,FaStar ,FaClock ,FaShoppingCart ,FaStore} from 'react-icons/fa';
import moment from 'moment';
import HeartIcon from './HeartIcon';
import Ratings from './Ratings';
import ProductTabs from '../Products/ProductsTabs';
...
const ProductDetails = () => {
  ...
  const [createReview ,{isLoading: loadingProductReview ,reset}] = useCreateReviewMutation();
  ...
  return (
    ...
    <div>
      ...
      {isLoading ? 
      (<Loader/>) :error? (<Message variant='danger'>{error?.data?.message || error.message}</Message>): (
        <>
