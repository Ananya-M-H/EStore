...
const ProductsTabs = ({loadingProductReview ,
    userInfo ,
    submitHandler ,
    rating ,
    setRating ,
                        ...
                        {userInfo ? (
                            <form onSubmit={submitHandler}>
                                <div className="my-2 ">
                                    ...
                                    <select name="rating" required value={rating} onChange={e =>setRating(e.target.value)}
                                 ...
                                 <div className="my-2">
                                    ...
                                    <textarea id="comment" cols="30" rows="3" required value={comment} onChange={e=>setComment(e.target.value)} 
                                    className="p-2 border rounded-lg xl:w-[40rem] text-white bg-[#1A1A1A]" 
                                    ></textarea>                
                                 </div>
